...
def main():
    ...
    # Filtro por aqueles que mencionem Anexo I e Anexo II
    pdf_links = {}

    for texto, href in links_encontrados:
        texto_lower = texto.lower()
        
        if "anexo i" in texto_lower or "anexo 1" in texto_lower:
            pdf_links["Anexo_I"] = urljoin(base_url, href)

        if "anexo ii" in texto_lower or "anexo 2" in texto_lower:
    ...
    # Cria pasta para armazenar os arquivos baixados
